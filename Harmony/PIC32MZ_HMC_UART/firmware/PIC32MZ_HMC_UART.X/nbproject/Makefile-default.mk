...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/PIC32MZ_HMC_UART.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/PIC32MZ_HMC_UART.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1641696933/ringbuffer.o: E\:/Workspace/PIC32MZ_EXAMPLES/Harmony/PIC32MZ_HMC_UART/firmware/src/ringbuffer.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1641696933" 
	@${RM} ${OBJECTDIR}/_ext/1641696933/ringbuffer.o.d 
	@${RM} ${OBJECTDIR}/_ext/1641696933/ringbuffer.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1641696933/ringbuffer.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD4=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"D:/Program Files (x86)/Microchip/xc32/v2.30/pic32mx/include" -ffunction-sections -O1 -I"../src" -I"../src/system_config/default" -I"../src/default" -I"../../../../../../microchip/harmony/v2_06/framework" -I"../src/system_config/default/framework" -MMD -MF "${OBJECTDIR}/_ext/1641696933/ringbuffer.o.d" -o ${OBJECTDIR}/_ext/1641696933/ringbuffer.o E:/Workspace/PIC32MZ_EXAMPLES/Harmony/PIC32MZ_HMC_UART/firmware/src/ringbuffer.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
